    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address_3', models.CharField(blank=True, max_length=200, null=True)),
                ('billing_address_4', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('jobsite_address_1', models.CharField(blank=True, max_length=200, null=True)),
                ('jobsite_address_2', models.CharField(blank=True, max_length=200, null=True)),
                ('jobsite_address_3', models.CharField(blank=True, max_length=200, null=True)),
                ('jobsite_address_4', models.CharField(blank=True, max_length=200, null=True)),
                ('jobsite_city', models.CharField(blank=True, max_length=200, null=True)),
                ('jobsite_state', models.CharField(blank=True, max_length=2, null=True)),
                ('jobsite_zip', models.CharField(blank=True, max_length=10, null=True)),
